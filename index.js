...
var risky = [
    ...
    "I dare you to kiss your bsf",
    "I dare you to play a song by slapping your  cheeks till someone guesses the song",
...
var truth = function () { 
    ...
    document.getElementById('pick').innerHTML = ("Unmaiya ah irunga bro" + "<br><br>" + honesty[randomTruth]); 
};

var dare = function (){ 
    var randomDare = (Math.floor(Math.random() * risky.length));
    document.getElementById('pick').innerHTML = ("***DARE***" + "<br><br>" + risky[randomDare]); 
};
